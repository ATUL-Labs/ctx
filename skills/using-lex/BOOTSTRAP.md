...
You have lex installed. Full protocol: read `skills/using-lex/SKILL.md` when needed.
...
15 skills available. Read `skills/<skill-name>/SKILL.md` when the task matches:
